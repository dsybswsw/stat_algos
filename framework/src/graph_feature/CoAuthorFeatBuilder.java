...
public class CoAuthorFeatBuilder {
    ...
    public CoAuthorFeatBuilder() {
        coauthorGraph = new CoAuthorGraph();
    }
    ...
    public double getCommonNeighbors(String nodeName1, String nodeName2) {
        List<DataArc> neighborSet1 = coauthorGraph.getUserNode(nodeName1).getNeighbors(EpinionConstants.FRIENDSHIP);
        List<DataArc> neighborSet2 = coauthorGraph.getUserNode(nodeName2).getNeighbors(EpinionConstants.FRIENDSHIP);

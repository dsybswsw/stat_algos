...
public class Node {
	...
	private Map<Set<SlotKey>, Stack<double[]>> beliefHistory;
	 ...
	 *
	 * @param name   The name for the random variable.
	 * @param states The name of each state of the random variable. These states are later accessable with
	...
	public Node(String name, String... states) {
		...
		beliefHistory = new HashMap<Set<SlotKey>, Stack<double[]>>();
	}
